...
IF NOT EXISTS(SELECT * FROM ResourceTypes WHERE Id = 'edition') INSERT INTO ResourceTypes VALUES('edition', 'Bible Edition');
...
-- Sections
-- -------------------------------------------------------------------------
IF NOT EXISTS(SELECT * FROM Sections WHERE Id = '101000000') INSERT INTO Sections VALUES(101000000, 'Law', 101000000) ;
IF NOT EXISTS(SELECT * FROM Sections WHERE Id = '106000000') INSERT INTO Sections VALUES(106000000, 'History', 106000000) ;
IF NOT EXISTS(SELECT * FROM Sections WHERE Id = '118000000') INSERT INTO Sections VALUES(118000000, 'Wisdom', 118000000) ;
IF NOT EXISTS(SELECT * FROM Sections WHERE Id = '123000000') INSERT INTO Sections VALUES(123000000, 'Major Prophets', 123000000) ;
IF NOT EXISTS(SELECT * FROM Sections WHERE Id = '128000000') INSERT INTO Sections VALUES(128000000, 'Minor Prophets', 128000000) ;
IF NOT EXISTS(SELECT * FROM Sections WHERE Id = '340000000') INSERT INTO Sections VALUES(340000000, 'Gospels', 340000000) ;
IF NOT EXISTS(SELECT * FROM Sections WHERE Id = '344000000') INSERT INTO Sections VALUES(344000000, 'Acts', 344000000) ;
IF NOT EXISTS(SELECT * FROM Sections WHERE Id = '345000000') INSERT INTO Sections VALUES(345000000, 'Pauline Epistles', 345000000) ;
IF NOT EXISTS(SELECT * FROM Sections WHERE Id = '358000000') INSERT INTO Sections VALUES(358000000, 'General Epistles', 358000000) ;
IF NOT EXISTS(SELECT * FROM Sections WHERE Id = '366000000') INSERT INTO Sections VALUES(366000000, 'Revelation', 366000000) ;
